 ...
 * @author ASUS
 */
public class CompanyShowInternsManagermentServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            log("NamingException at CompanyShowInternsManagermentServlet " + ex.getMessage());
        } catch (SQLException ex) {
            log("SQLException at CompanyShowInternsManagermentServlet " + ex.getMessage());
        }
    }
