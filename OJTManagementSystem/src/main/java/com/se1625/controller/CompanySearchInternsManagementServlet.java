 ...
 * @author ASUS
 */
public class CompanySearchInternsManagementServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            if (session != null) {
                ...
                if (accountDTO != null) {
                    ...
                    for (TblApplicationDTO tblApplicationDTO : applicationList) {
                        ...
                        //check status 
                        if (selectStatus.isEmpty() == false && !(tblApplicationDTO.getIsPass() == status)) {
                            check = false;
                        }
            ...
            log("NamingException at CompanySearchInternsManagementServlet " + ex.getMessage());
        } catch (SQLException ex) {
            log("SQLException at CompanySearchInternsManagementServlet " + ex.getMessage());
        }
    }
